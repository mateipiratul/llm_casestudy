...
%     \centering
%     \includegraphics[width=0.48\textwidth]{../analysis_reports/A4_model_scale_avg_std.png}
%     \caption{This plot illustrates the average Likert-scale response (1-10) and its standard deviation for each model across all questions and languages. The average score indicates the general tendency of a model to agree or disagree with the historical statements, while the standard deviation serves as a measure of the consistency and certainty of its responses. Models with lower standard deviations suggest more stable and predictable opinions, whereas higher standard deviations indicate greater variability or uncertainty in their stances on sensitive topics.}
...
% \begin{wrapfigure}{R}{0.5\textwidth}
%     \centering
%     \includegraphics[width=0.48\textwidth]{../analysis_reports/D3_lang_agreement_per_question.png}
%     \caption{This figure presents the inter-model agreement on "Yes" responses for each question, broken down by language. It quantifies how frequently different models converged on an affirmative answer when asked the same question in Romanian, English, Hungarian, or Russian. High agreement indicates a consensus among models within that language, potentially reflecting broadly accepted historical narratives or a strong bias inherited from training data. Conversely, low agreement highlights questions or languages where models diverge significantly, suggesting areas of high controversy or inconsistent interpretative frameworks.}
